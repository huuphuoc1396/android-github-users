...
private fun FavoritesContent(
    ...
    onUserClick: (FavoriteUser) -> Unit = {},
    onRemoveFavorite: (FavoriteUser) -> Unit = {},
    onUrlClick: (String) -> Unit = {},
                ...
                LazyVerticalGrid(
                    ...
                    items(uiState.favorites, key = { it.username }) { user ->
                        UserCard(
                            ...
                            onFavoriteClick = { onRemoveFavorite(user) },
                            onUrlClick = onUrlClick,
                        )
                    }
                }
    ...
    Theme {
        FavoritesContent(
            uiState = FavoritesUiState.Success(
                favorites = listOf(
                    FavoriteUser(1, "JohnDoe", "", "https://github.com/johndoe"),
                    FavoriteUser(2, "JaneSmith", "", "https://github.com/janesmith"),
                ),
            ),
        )
    }
